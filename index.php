...
"./assets/img/home_icon.png" 
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="./assets/img/home_icon.png"width="100px"height="100px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <!-- TO DISPLAY THE NAME AFTER LOGIN-->
            <?php 
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Homies Rental System!</div>
          <div class="intro-heading text-uppercase">It feels so happy to see you again.<br></div>
        </div>
      </div>
    </header>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Homies 2021</span>
          </div>
          <div class="col-md-4">
